...
haxelib git hxcpp https://github.com/NovaFlare-Engine-haxelib/hxcpp-4.3.2-legacy --quiet #Just a normal hxcpp
haxelib git lime https://github.com/ArkoseLabsOfficial/lime-7.7.0 --quiet #repo owner helped to fix termux problem
...
haxelib git funkin.vis https://github.com/NovaFlare-Engine-haxelib/funkVis-FrequencyFixed main --quiet
